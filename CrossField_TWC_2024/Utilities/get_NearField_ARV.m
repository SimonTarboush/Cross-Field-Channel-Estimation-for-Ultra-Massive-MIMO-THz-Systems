...
% dist_exact: Exact distance between AEs based on the Line-of-sight path
% dist: Communication distance based on far-field approximation
% lambda: Wavelength
% Output Arguments:
% b: The near-field array response vector (Eq. 9 in the manuscript) 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function  b= get_NearField_ARV(Qbar, dist_exact, dist, lambda)
b = exp(-1j*2*pi*(dist_exact-dist)/lambda)/sqrt(Qbar);
end