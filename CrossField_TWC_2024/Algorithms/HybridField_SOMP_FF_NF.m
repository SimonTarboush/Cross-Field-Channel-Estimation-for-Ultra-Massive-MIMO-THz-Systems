...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This function implements the Hybrid-field SOMP algorithm by first estimating the far-field (FF) components and substract their effect 
% after that start estimating the near-field (NF) components
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [H_est_Far, Support_Far, H_est_Near, Support_Near] = HybridField_SOMP_FF_NF(y, Upsilon_Far, Upsilon_Near, Pilot_pwr, Lbar, K)
R = y;
...
for ell =1: Lbar/2 % threshold = sparsity level
    ...
    % Update residual
    if ~isempty(Support_Far)
        R = y - sqrt(Pilot_pwr)*Upsilon_Near(:,Index_Near)*H_est_Near(Index_Near,:)- sqrt(Pilot_pwr)*Upsilon_Far(:,Support_Far)*H_est_Far(Support_Far,:);
    else
